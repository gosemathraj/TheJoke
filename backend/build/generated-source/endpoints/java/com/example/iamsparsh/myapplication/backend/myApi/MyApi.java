 ...
 * on 2017-01-21 at 14:38:36 UTC 
 * Modify at your own risk.
 */

package com.example.iamsparsh.myapplication.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public GetJoke getJoke(java.lang.Integer id) throws java.io.IOException {
    GetJoke result = new GetJoke(id);
    initialize(result);
    return result;
  }

  public class GetJoke extends MyApiRequest<com.example.iamsparsh.myapplication.backend.myApi.model.Jokes> {

    private static final String REST_PATH = "jokes/{id}";
     ...
     * @since 1.13
     */
    protected GetJoke(java.lang.Integer id) {
      super(MyApi.this, "GET", REST_PATH, null, com.example.iamsparsh.myapplication.backend.myApi.model.Jokes.class);
    ...
    public GetJoke setId(java.lang.Integer id) {
      this.id = id;
      return this;
    }
  ...
  public class SayHi extends MyApiRequest<com.example.iamsparsh.myapplication.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.example.iamsparsh.myapplication.backend.myApi.model.MyBean.class);
