...
package com.example.iamsparsh.myapplication.backend.myApi.model;
...
public final class Jokes extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<java.lang.String> jokesList;

  /**
   * @return value or {@code null} for none
   */
  public java.util.List<java.lang.String> getJokesList() {
    return jokesList;
  }

  /**
   * @param jokesList jokesList or {@code null} for none
   */
  public Jokes setJokesList(java.util.List<java.lang.String> jokesList) {
